...
namespace TestProject.Generated.Tests.MyFirstProject
{
	...
	/// Generated on: 10/13/2021 01:01:30
	/// </summary>
	public class CP006 : IWebTest
	{
		...
		[ParameterAttribute(DefaultValue = "Deiv8", Direction = ParameterDirection.Input)]
		...
		public ExecutionResult Execute(WebTestHelper helper)
		{
			...
			// Add step sleep time (Before)
			Thread.Sleep(500);
			boolResult = driver.TestProject().ScrollWindow(0, 500);
			report.Step("Scroll window by ('0','500')", boolResult, TakeScreenshotConditionType.Failure);
